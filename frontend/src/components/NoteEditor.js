  ...
  return (
    <div className='px-12'>
      <div className='h-5 mt-1'>
        <span className='text-gray-500'>{createdTime && dateFormater.format(createdTime)}</span>
      </div>
      <form className='text-left' onSubmit={handleSubmit()}>
        <input type="text" placeholder="Title" {...register("title", {})} onInput={handleTyping} className="outline-none text-xl font-bold" />
        <br />
        <textarea
